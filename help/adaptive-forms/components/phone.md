---
title: アダプティブ Forms コアコンポーネント – 電話入力、電話
...
タブを使用して、コンポーネントの CSS スタイルの定義と管理を行います。アダプティブなForms Phone コアコンポーネントは、AEMをサポートしています [スタイルシステム](/help/get-started/authoring.md#component-styling).

![デザインダイアログ](/help/adaptive-forms/assets/telephoneinput_designdialog.png)

- **デフォルトの CSS クラス**：アダプティブ Forms Phone コアコンポーネントのデフォルト CSS クラスを指定できます。
