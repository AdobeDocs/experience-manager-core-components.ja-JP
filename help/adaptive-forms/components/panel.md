...
- **セクション見出しの下にフィールドをグループ化**：共通セクション見出しの下に関連するフォームフィールドを整理するには、このオプションを選択します。 このグループ化により、スクリーンリーダーなどの支援テクノロジーが、グループ化されたフィールドを単一の統一されたユニットとして識別および読み上げできるようになり、すべてのユーザーのフォームのアクセシビリティとナビゲーションが向上します。
