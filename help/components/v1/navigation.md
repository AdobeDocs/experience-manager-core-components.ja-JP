...
ナビゲーションコンポーネントは、サイトのグローバル化されたサイト構造を自動的に検出し、[&#x200B; ローカライズされたページに自動的に適応する &#x200B;](#localized-site-structure) ことができます。 さらに、メインのコンテンツ構造以外の別の構造を表すために、[&#x200B; シャドウリダイレクトページ &#x200B;](#shadow-structure) を使用して、任意のサイト構造をサポートできます。
