...
ティーザーコンポーネント（[&#x200B; リリース 2.23.2](/help/versions.md)時点）は、リモートアセットをサポートしています。[&#128279;](/help/developing/remote-assets.md)を設定したら、ティーザーコンポーネントのリモートサービスからアセットを選択できます。
...
ティーザーのタイトル、説明、画像は、リンクされたページから、または最初のcall to actionでリンクされたページから継承できます。 リンクもcall to actionも指定しない場合、タイトル、説明、画像は現在のページから継承されます。
...
ティーザーコンポーネントは、[アドビクライアントデータレイヤー](/help/developing/data-layer/overview.md)をサポートしています。
