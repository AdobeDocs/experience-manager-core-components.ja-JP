...
|---|---|---|---|---|---|---|---|
| [2.29.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.29.0) | このリリースでは、Sites コアコンポーネントでのアセットのプレビューバージョンのオーサリングがサポートされるようになり、多数のバグ修正に対応しています。 | - | 6.5.21.0+ | 6.5 LTS GA | 継続的 | 8、11 | 2025 年 4 月 21 日（Pt） |
